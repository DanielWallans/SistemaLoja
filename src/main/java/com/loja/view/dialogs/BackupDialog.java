...
public class BackupDialog extends JDialog {
    ...
    private void initComponents() {
        ...
        JLabel lblSub = new JLabel("Exporte cópias compactadas em .ZIP ou restaure o banco em caso de troca de computador.");
        ...
        JLabel lblAvisoRest = new JLabel("<html><font color='#c0392b'><b>ATENÇÃO:</b> A restauração substitui os dados atuais do banco pelos dados do arquivo selecionado.</font></html>");
        ...
        SwingUtilities.invokeLater(() -> {
            ...
            if (res.isSucesso()) {
                ...
                String logMsg = String.format("=========================================\n" +
                        ...
                        "=========================================\n",
                        res.getCaminhoArquivo(), res.getTotalTabelas(), res.getTotalRegistros(), res.getTamanhoKb(), res.getTempoMs());
                txtLog.append(logMsg);
                JOptionPane.showMessageDialog(this, "Backup gerado com sucesso em:\n" + res.getCaminhoArquivo(), "Backup Concluído", JOptionPane.INFORMATION_MESSAGE);
            } else {
    ...
    private void executarRestauracao() {
        ...
        if (opt == JFileChooser.APPROVE_OPTION) {
            ...
            int confirm = JOptionPane.showConfirmDialog(this,
                    "⚠️ ATENÇÃO: Deseja realmente restaurar o banco de dados?\n\n" +
            ...
            SwingUtilities.invokeLater(() -> {
                ...
                if (res.isSucesso()) {
                    ...
                    JOptionPane.showMessageDialog(this, res.getMensagem(), "Restauração Concluída", JOptionPane.INFORMATION_MESSAGE);
                } else {
                    lblStatusOperacao.setText("❌ " + res.getMensagem());
                    lblStatusOperacao.setForeground(new Color(231, 76, 60));
                    txtLog.append("❌ ERRO RESTAURAÇÃO: " + res.getMensagem() + "\n");
                    JOptionPane.showMessageDialog(this, res.getMensagem(), "Erro na Restauração", JOptionPane.ERROR_MESSAGE);
                }
            });
        }
    }
